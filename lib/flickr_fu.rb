...
%w(base test auth token photos photo photo_response comment note size uploader status people person license errors contacts contact geo location urls).each do |file|
