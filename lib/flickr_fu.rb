...
%w(base test auth token photos photo photo_response photosets photoset comment note size uploader status people person license errors contacts contact).each do |file|
